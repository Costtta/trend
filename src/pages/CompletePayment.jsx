                        ...
                        {steps.map((label, index) => {
                            ...
                            return (
                                <Step key={label} {...stepProps} sx={{ backgroundColor: '#DAFFDB', borderRadius: '80px' }} completed={completed}>
                                    <StepLabel icon={completed ? <CheckCircleIcon sx={{ color: '#1EC815' }} /> : <RadioButtonUncheckedIcon sx={{ color: 'black' }} />}
                                        sx={{
                                            '& .MuiStepLabel-label': {
                                                '&.Mui-active': {
                                                    color: 'black',
                    ...
                    {activeStep === steps.length ? (
                        ...
                        <>
                            ...
                            <Box sx={{ textAlign: 'center', py: 10 }}>
                                <Button onClick={handleNext} sx={{ textTransform: 'capitalize', backgroundColor: theme.palette.warning.main, color: 'white', width: '100%', borderRadius: '18px' }}>
